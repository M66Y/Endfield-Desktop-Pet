...
<img src="docs/demo.gif" width="200" alt="洁尔佩塔演示动画：待机 → 踢腿 → 害羞 → 开心 → 哭泣">&nbsp;<img src="docs/lewantin.gif" width="200" alt="莱万汀演示动画：持雪糕 → 吃雪糕 → 掉了委屈 → 生气抱臂 → 打瞌睡 → 被叫醒"><br>
<img src="docs/zhuangfangyi.gif" width="200" alt="庄方宜演示动画：安静待机 → 害羞 → 疑惑 → 比心 → 生气 → 开心">&nbsp;<img src="docs/tangtang.gif" width="200" alt="汤汤演示动画：待机倒茶 → 打哈欠 → 开心蹦跳 → 害羞">

# Gilberta Desktop · 桌宠（洁尔佩塔 & 莱万汀 & 庄方宜 & 汤汤）

**《明日方舟：终末地》Q 版桌面宠物** · v1.5

<table><tr>
<td align="center" width="50%"><b>洁尔佩塔</b><br>狐耳小姑娘，画面 1:1 取自官方风格立绘（抠图切件、原样拼合），会呼吸、眨眼、摇尾巴，偶尔自己害羞一下</td>
<td align="center" width="50%"><b>莱万汀</b><br>红卷发黑尖角的慵懒小姑娘，盘腿坐着举一支老冰棒，「雪糕小剧场」六动作全线上线</td>
</tr><tr>
<td align="center" width="50%"><b>庄方宜</b><br>红角青发的安静小姑娘，站姿举茶倒水的温柔性子——害羞、疑惑、比心、闷气、难得的雀跃，五种情绪全 上线</td>
<td align="center" width="50%"><b>汤汤</b><br>紫灰发兽耳的小虎崽，守着茶桌倒茶待机——会打哈欠、开心蹦跳、害羞遮脸（帧序列动画）</td>
</tr></table>
...
- **庄方宜·五种情绪**：安静站姿倒茶待机；<kbd>Alt</kbd>+<kbd>1</kbd>～<kbd>5</kbd> 直选「害羞」（捧颊扭捏）「疑惑」（托腮问号）「比心」（心跳扑通）「生气」（攥拳闷气）「开心」（难得的雀跃挥手）。
- **汤汤·茶桌小虎崽**：守着茶桌倒茶待机；<kbd>Q</kbd> / <kbd>Alt</kbd>+<kbd>1</kbd>～<kbd>3</kbd> 播放「打哈欠」「开心蹦跳」「害羞」——帧序列动画（哈欠三连、腾空蹦跳带星星、捂脸扭捏）。
- **待机也有戏**：洁尔佩塔呼吸、眨眼、尾巴飘、耳朵抖，偶尔歪头害羞；莱万汀与汤汤呼吸起伏 + 轻轻摇曳。
- **随手拖走**：按住拖到屏幕任意位置，松手还会晃两下才站稳。拖拽可以打断任何动作——也能把睡着的莱万汀拖醒。
- **多宠并行**：四只可以同时住在桌面上；键盘只作用于**鼠标悬停 / 点击选中**的那一只，互不串扰。
...
国内网络拉取 Electron 较慢时，先执行 `set ELECTRON_MIRROR=https://npmmirror.com/mirrors/electron/` 再 `npm install`。也可以直接双击对应桌宠的 `启动XX.bat`。
