...
with open(f'{OUT}/manifest.js', 'w', encoding='utf8') as f:
    ...
    f.write(';\n')
print(f'assets/pets/jielpeita/pets/jielpeita/shy_00.webp saved, clips.shy ox={ox} oy={oy} w={w2} h=622')
...
prev.convert('RGB').save('tools/pets/jielpeita/dbg_shy_pose.png')
